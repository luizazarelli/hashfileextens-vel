    ...
    switch (face) {
        case 'N':
            ...
            *out_y = q_info->y + q_info->h;
            break;
        case 'S': // S nos .qry aponta para face leste (x+w, y+num) – mantido por compatibilidade com gabarito
        case 'L': // leste
        case 'W': // W utilizado nos .qry aponta para face leste (x+w) – mantido por compatibilidade com gabarito
